...
TOTAL_SAMPLES=5000 # For hendrycks-MATH-benchmark test set
SAMPLES_PER_JOB=$(( (TOTAL_SAMPLES + NUM_JOBS - 1) / NUM_JOBS )) # Ceiling division
...
for i in $(seq 0 $((NUM_JOBS - 1))); do
    ...
    CUDA_VISIBLE_DEVICES=$GPU_ID python /scratch/jacopo04/rely/rely/inference/sbs_uncertain.py \
        --dataset nlile/hendrycks-MATH-benchmark \
        --output_dir ./flop_results/sbs_uncertain_max_4_20 \
